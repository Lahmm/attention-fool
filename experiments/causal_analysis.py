...
def build_baseline(num_classes, dim=True, guide_aug=True, guide_methods=("dropout","jitter","freq")):
    ...
    attacker=create_attacker(model=source,epsilon=16/255,step_size=None,steps=40,ti_sigma=0,
        dim=dim,mi=True,mi_decay=1,dim_resize_range=(.85,1),
        guide_aug=guide_aug,guide_aug_methods=guide_methods,guide_aug_copies=3,guide_aug_strength=.2)
