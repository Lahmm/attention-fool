...
- Generate adversarial samples with FFT-stable patch score residual pollution MI-FGSM:
  `python main.py --mode attack --attack-type fft-residual-pollution --max-attacked-samples 5 --epsilon 0.0313725 --steps 10 --decay 1.0 --layers=-4,-2,-1 --lambda-ce 1.0 --lambda-pollution 1.0 --lambda-residual 1.0 --fft-topk 1 --output-dir outputs/attack_fft_residual`
